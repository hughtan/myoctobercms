<?php namespace Hughtan\Import\Controllers;
...
class Upload extends \Backend\Classes\Controller {
    ...
    public function __construct()
    {
        ...
        SettingsManager::setContext('Hughtan.Import', 'settings');
            ...
            if (Input::file('plugin')->isValid()) 
            {
                ...
                if($extension=='zip')
                {
                    ...
                    if ($res === TRUE) 
                    {
                        ...
                        Flash::success(Lang::get('hughtan.import::lang.plugin.success'));
                    ...
                    {
                        Flash::error(Lang::get('hughtan.import::lang.plugin.error'));
                    }
                }
                else
                {
                    Flash::error(Lang::get('hughtan.import::lang.plugin.invalid'));
                }
            }
            else
            {
                Flash::error(Lang::get('hughtan.import::lang.plugin.empty'));
            }
        }   
