...
class Post extends Model
{
    ...
    public $implement = ['@Hughtan.Translate.Behaviors.TranslatableModel'];
    ...
    public $rules = [
        'title'   => 'required',
        'slug'    => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:hughtan_blog_posts'],
        'content' => 'required',
        'excerpt' => ''
    ];
    ...
    public static $allowedSortingOptions = [
        'title asc'         => 'hughtan.blog::lang.sorting.title_asc',
        'title desc'        => 'hughtan.blog::lang.sorting.title_desc',
        'created_at asc '   => 'hughtan.blog::lang.sorting.created_asc',
        'created_at desc'   => 'hughtan.blog::lang.sorting.created_desc',
        'updated_at asc'    => 'hughtan.blog::lang.sorting.updated_asc',
        'updated_at desc'   => 'hughtan.blog::lang.sorting.updated_desc',
        'published_at asc'  => 'hughtan.blog::lang.sorting.published_asc',
        'published_at desc' => 'hughtan.blog::lang.sorting.published_desc',
        'random'            => 'hughtan.blog::lang.sorting.random'
    ];
    ...
    public function filterFields($fields, $context = null)
    {
        ...
        if (!$user->hasAnyAccess(['hughtan.blog.access_publish'])) {
    ...
    public function afterValidate()
    {
        if ($this->published && !$this->published_at) {
            throw new ValidationException([
               'published_at' => Lang::get('hughtan.blog::lang.post.published_validation')
            ]);
        }
    }
    ...
    {
        return ($this->user_id == $user->id) || $user->hasAnyAccess(['hughtan.blog.access_other_posts']);
    }
     ...
     *
     * @param \Hughtan\Pages\Classes\MenuItem $item Specifies the menu item.
