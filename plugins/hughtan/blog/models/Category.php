...
class Category extends Model
{
    ...
    public $table = 'hughtan_blog_categories';
    ...
    public $rules = [
        'name' => 'required',
        'slug' => 'required|between:3,64|unique:hughtan_blog_categories',
        'code' => 'nullable|unique:hughtan_blog_categories',
    ];
    ...
    public $belongsToMany = [
        'posts' => ['Hughtan\Blog\Models\Post',
