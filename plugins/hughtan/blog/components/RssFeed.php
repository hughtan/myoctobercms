...
class RssFeed extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'hughtan.blog::lang.settings.rssfeed_title',
            'description' => 'hughtan.blog::lang.settings.rssfeed_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'blogPage' => [
                'title'       => 'hughtan.blog::lang.settings.rssfeed_blog',
                'description' => 'hughtan.blog::lang.settings.rssfeed_blog_description',
                'type'        => 'dropdown',
                'default'     => 'blog/post',
